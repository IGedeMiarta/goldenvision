        ...
        <div class="card"
            ...
            <div class="card-body" style="display: flex; justify-content: space-between">
                <div class="col-md-6 col-sm-6" style="text-align: start;">
                    ...
                    <h6 class="text-dark" style="font-size: 18px">
                        {{ nb(getAmount(auth()->user()->total_binary_com + auth()->user()->total_ref_com + sumBonus('leader'))) }}
                        IDR</h6>
                </div>
                <div class="col-md-6 col-sm-6" style="display: flex; justify-content: end">
                    <div class="icon-rp-total">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Convert B-Wallet to Cash</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('user.convert.bwallet') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small id="amountHelp" class="form-text text-info">You Have
                            {{ nb(auth()->user()->b_balance) }} IDR to convert</small>
                    </div>
                </div>
