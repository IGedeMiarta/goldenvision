                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('RO Limit')</th>
                                    <th scope="col">@lang('Equals POINT')</th>
                            ...
                            <tbody>
                                @forelse($plans as $key => $plan)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Price')">{{ nb($plan->price) }}
                                            {{ $general->cur_text }}</td>
                                        {{-- <td data-label="@lang('Bv')">{{ $plan->bv }}</td> --}}
                                        <td data-label="@lang('Referral Commission')"> {{ nb($plan->ref_com) }}
                                            {{ $general->cur_text }}</td>

                                        <td data-label="@lang('Tree Commission')">
                                            {{ nb($plan->tree_com) }} {{ $general->cur_text }}
                                        </td>
                                        <td data-label="@lang('Tree Commission')">
                                            {{ nb($plan->ro_limit) }} {{ $general->cur_text }}
                                        </td>
                                        <td data-label="@lang('POINT')">
                                            {{ getAmount($plan->point) }} POINT
                                        </td>
                                        <td data-label="@lang('Status')">
                                            ...
                                            @else
                                                <span
                                                    class="text--small badge font-weight-normal badge--danger">@lang('Disabled')</span>
                                            @endif
                                        </td>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button type="button" class="icon-btn edit" data-toggle="tooltip"
                                                ...
                                                data-ro_limit="{{ getAmount($plan->ro_limit) }}"
                                                data-point="{{ getAmount($plan->point) }}" data-original-title="Edit">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('admin.plan.update') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">@lang('RO Limit')</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text">{{ $general->cur_sym }}
                                    </span></div>
                                <input type="text" class="form-control  ro_limit" name="ro_limit" required>
                            </div>
                            <small class="small text--red">@lang('When someone buys this plan, limit RO will increase')</small>
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">@lang('POINT')</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text">{{ 'P' }}
                                    </span></div>
                                <input type="text" class="form-control  point" name="point" required>
                            </div>
                            <small class="small text--red">@lang('When someone buys this plan, will get product point')</small>
                        </div>
    ...
    <script>
        ...
        (function($) {
            $('.edit').on('click', function() {
                ...
                modal.find('.ro_limit').val($(this).data('ro_limit'));
                modal.find('.point').val($(this).data('point'));
