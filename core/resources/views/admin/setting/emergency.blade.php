                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Balance Transfer Carge')
                                        (@lang('Fixed'))</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Per Question Paid')
                                        (@lang('Survey'))</label>
                                    <div class="input-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                                        data-off="@lang('Disabled')" name="agree_policy"
                        ...
                        <div class="row justify-content-between mb-5">
                            <div class="col-md-4">
                                <div class="input-group custom-height">
                                    <input type="text" class="form-control form-control-lg"
                                        value="{{ $general->total_bv }}" name="total_bv" id="#"
                            ...
                            <div class="col-lg-4">
                                <div class="input-group mb-3 custom-height">
                                    ...
                                    <input type="text" class="form-control form-control-lg"
                                        value="{{ $general->max_bv }}" name="max_bv"
